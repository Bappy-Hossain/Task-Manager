                    ...
                    <div className="col-md-7 col-lg-6 center-screen">
                        <div className="card w-90  p-4">
                            ...
                            <div className="card-body">
                                ...
                                <br/>
                                <button onClick={SubmitLogin} className="btn w-100 animated fadeInUp btn-primary">Next</button>
                                <hr/>
                                <div className="float-end mt-3">
                                    <span>
                                        <Link className="text-center ms-3 h6 animated fadeInUp" to="/Registration">Sign Up </Link>
                                        <span className="ms-1">|</span>
                                        <Link className="text-center ms-2 h6 animated fadeInUp" to="/SendOTP">Forget Password</Link>
                                    </span>
                                </div>
                            </div>
                        </div>
